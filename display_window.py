...
class Ui_DISPLAY_WINDOW(object):
    def setupUi(self, DISPLAY_WINDOW):
        ...
        self.table_label = QtWidgets.QLabel(DISPLAY_WINDOW, text=database_home.data.table_name)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.table = QtWidgets.QLabel(DISPLAY_WINDOW, text="TABLE:")
        self.table.setFont(font)
        self.table.setStyleSheet("color: rgb(255, 255, 255);")
        self.table.setGeometry(20, 10, 70, 30)
        self.table_label.setFont(font)
        self.table_label.setStyleSheet("color: rgb(255, 255, 255);")
        self.table_label.setGeometry(QtCore.QRect(90, 10, 100, 30))
